...
public class TestConfig{
	...
	public static String from = "thoufiktester@gmail.com";
	public static String password = "Whiterhino@88";
	public static String[] to ={"t.ahamedmtp@gmail.com","thoufikwork@gmail.com"};
